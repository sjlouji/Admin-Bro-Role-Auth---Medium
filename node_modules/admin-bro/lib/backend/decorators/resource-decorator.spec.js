...
describe('ResourceDecorator', function () {
  ...
  describe('#decorateProperties', function () {
    beforeEach(function () {
      this.PropertyDecoratorSpy = _sinon.default.spy(_propertyDecorator.default);
      ...
      this.decorator = new _resourceDecorator.default(_objectSpread(_objectSpread({}, args), {}, {
        options: this.options
      }));
    });
    it('decorates all default properties - default and newProperty', function () {
      (0, _chai.expect)(Object.keys(this.decorator.properties)).to.have.lengthOf(this.defaultProperties.length + 1);
    });
    it('returns default property with options', function () {
      (0, _chai.expect)(this.decorator.properties[this.defaultPropertyName].options).to.deep.equal(this.defaultPropertyOptions);
    });
    it('returns custom property with options', function () {
      (0, _chai.expect)(this.decorator.properties.newProperty.options).to.deep.equal(this.customPropertyOptions);
    });
    it('does not pass options where there were not given', function () {
      (0, _chai.expect)(this.decorator.properties[this.originalPropertyName].options).to.deep.equal({});
    });
  });
  ...
  describe('#toJSON', function () {
    it('returns JSON representation of a resource', function () {
      ...
      (0, _chai.expect)(json).to.have.keys('id', 'name', 'parent', 'href', 'actions', 'titleProperty', 'resourceActions', 'listProperties', 'editProperties', 'showProperties', 'filterProperties', 'properties');
    });
