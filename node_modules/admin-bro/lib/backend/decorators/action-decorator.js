...
var _layoutElementParser = _interopRequireDefault(require("../utils/layout-element-parser"));
...
class ActionDecorator {
  ...
  layout(currentAdmin) {
    if (this.action.layout) {
      ...
      return layoutConfig.map(element => (0, _layoutElementParser.default)(element));
    }
