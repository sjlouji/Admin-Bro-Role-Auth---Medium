 ...
 */
export declare type FormGroupProps = SpaceProps & {
    /**
 ...
 */
declare const FormGroup: import("styled-components").StyledComponent<"div", import("styled-components").DefaultTheme, FormGroupProps, never>;
export { FormGroup };
